...
class StackedBarGrapher:
    ...
    def stackedBarPlot(self,
                       ...
                       yTicks = 5,                         # information used for making y ticks ["none", <int> or [[tick_pos1, tick_pos2, ... ],[tick_label_1, tick_label2, ...]]
...
# plot
        ...
        ax.legend(handles[::-1], labels[::-1], title='Step', loc='center left', bbox_to_anchor=(1, 0.5))
        ax.legend().draggable()
###############################################################################
###############################################################################
###############################################################################
